...
CREATE TABLE IF NOT EXISTS `auth` (
  ...
  `grade` tinyint unsigned DEFAULT '1',
  PRIMARY KEY (`id`)
...
INSERT INTO `auth` (`id`, `userid`, `passwd`, `username`, `email`, `created`, `grade`) VALUES
	(1, 'sb', '111111', '이세빈', 'gobltpqls99@naver.com', '2021-01-29 15:53:11', 1);
...
INSERT INTO `board` (`id`, `title`, `content`, `writer`, `created`, `orifile`, `savefile`, `readnum`, `uid`) VALUES
	(1, '최연준 얼굴이 나라다', '', 'YJ', '2021-02-02 09:52:11', 'yj.png', '210202_09-b6ab9cde-3f00-4cde-b1c7-567641151881.png', 0, 0);
...
-- 테이블 데이터 sb.board_ip:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 sb.city:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 sb.sessions:~1 rows (대략적) 내보내기
/*!40000 ALTER TABLE `sessions` DISABLE KEYS */;
INSERT INTO `sessions` (`session_id`, `expires`, `data`) VALUES
	('syFkeFHV5hHsTerKGz8g5otEiYm_AkU1', 1612489740, '{"cookie":{"originalMaxAge":null,"expires":null,"secure":false,"httpOnly":true,"path":"/"}}');
